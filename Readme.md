...
graph LR
    %% Data Layer (Sources)
    subgraph Raw_OLTP_Sources["Raw OLTP Sources"]
    ...
    %% Staging Layer
    subgraph Staging_Layer_L1["Staging Layer (L1)"]
    ...
    subgraph Core_Dimensional_Layer_L2["Core Dimensional Layer (L2)"]
    ...
    subgraph Data_Marts_Layer_L3["Data Marts Layer (L3)"]
